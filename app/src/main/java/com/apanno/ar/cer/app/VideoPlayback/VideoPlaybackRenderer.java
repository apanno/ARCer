...
import com.apanno.ar.SampleApplication.SampleAppRenderer;
...
import com.apanno.ar.SampleApplication.SampleAppRendererControl;
import com.apanno.ar.SampleApplication.utils.SampleMath;
import com.apanno.ar.SampleApplication.utils.SampleUtils;
...
import com.apanno.ar.cer.app.VideoPlayback.VideoPlayerHelper.MEDIA_TYPE;


// The renderer class for the cer sample.
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    void initRendering()
    {
        Log.d(LOGTAG, "cer VideoPlaybackRenderer initRendering");
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            SampleUtils.checkGLError("cer renderFrame");
        }
